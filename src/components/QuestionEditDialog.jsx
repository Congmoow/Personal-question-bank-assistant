      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {type === 'fill' && (
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              答案 <span className="text-danger">*</span>
              <span className="text-xs text-gray-400 ml-2">（多个答案用 | 分隔）</span>
            </label>
            <input
              type="text"
              value={answer}
              ...
              className={cn(
                "w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border rounded-lg text-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none",
